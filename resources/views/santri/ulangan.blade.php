                        ...
                        <div class="pb-5">
                            <div class="d-flex flex-column flex-center">
                                <div class="symbol symbol-120 symbol-circle symbol-success overflow-hidden">
                                    <span class="font-size-h1 symbol-label font-weight-boldest text-capitalize">@php $inisial = getInitials(Auth::user()->name) @endphp {{ $inisial }}</span>
                                </div>
                                <a class="card-title font-weight-bolder text-dark-75 text-hover-primary font-size-h4 m-0 pt-7 pb-1 text-capitalize">{{ Auth::user()->name }}</a>
                    ...
                    <table class="table table-striped table-bordered table-hover table-checkable datatable" style="margin-top: 13px !important">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="ctr">{{ ($data->ulangan($val)) ? $data->ulangan($val)['ulha_1'] : " - " }}
                                </td>
                                <td class="ctr">{{ ($data->ulangan($val)) ? $data->ulangan($val)['ulha_2'] : " - " }}
                                </td>
                                <td class="ctr">{{ ($data->ulangan($val)) ? $data->ulangan($val)['uts'] : " - " }}</td>
                                <td class="ctr">{{ ($data->ulangan($val)) ? $data->ulangan($val)['ulha_3'] : " - " }}
                                </td>
...
@section('script')
    <script>
        ...
        $("#Ulangansantri").addClass("menu-item-active");
    </script>
@endsection
