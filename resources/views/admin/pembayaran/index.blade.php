                ...
                <div class="card-header py-3">
                    ...
                    <div class="card-toolbar">
                        <div class="dropdown dropdown-inline mr-2">
                            <button type="button" class="btn btn-icon btn-outline-primary btn-sm" data-toggle="modal" data-target=".tambah-data-pembayaran">
                    ...
                    <table id="example1" class="table table-striped table-bordered table-hover table-checkable datatable" style="margin-top: 13px !important">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('data-pembayaran.show', Crypt::encrypt($data->id)) }}" class="btn btn-icon btn-outline-success btn-sm">
                ...
                <div class="modal-body">
                    <form action="{{ route('data-pembayaran.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <select id="santri_id" name="santri_id" class="form-control @error('santri_id') is-invalid @enderror">
                                <option value="">-- Pilih Santri --</option>
                                @foreach ($santri as $data)
                                    <option value="{{ $data->id }}">{{ $data->nama_santri }}</option>
                                @endforeach
                            </select>
                        </div>
...
@section('script')
    <script>
        ...
        $("#DataPembayaran").addClass("menu-item-open");
    </script>
