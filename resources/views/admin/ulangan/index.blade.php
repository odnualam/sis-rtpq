            ...
            <div class="card-header py-3">
                ...
                <div class="card-toolbar">
                    <div class="dropdown dropdown-inline mr-2">
                        <a href="{{ route('ulangan-kelas') }}" class="btn btn-default btn-sm">
                ...
                <div class="col-md-12">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $data->nisn }}</td>
                            <td><a href="{{ route('ulangan-show', Crypt::encrypt($data->id)) }}" class="btn btn-icon btn-outline-info btn-sm"><i class="flaticon-eye"></i></a></td>
                        </tr>
                        @endforeach
                    </tbody>
                    </table>
