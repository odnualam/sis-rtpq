                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input disabled="disabled" type="text" value="{{ $santri->nisn }}" id="nisn" name="nisn" onkeypress="return inputAngka(event)" class="form-control @error('nisn') is-invalid @enderror">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('alamat_santri') is-invalid @enderror" name="alamat_santri" id="alamat_santri" cols="30" rows="5">{{ $santri->alamat_santri }}</textarea>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" value="{{ $santri->anak_ke }}" id="anak_ke" name="anak_ke" class="form-control @error('anak_ke') is-invalid @enderror" placeholder="2 dari 3 bersaudara">
                            </div>
                            <div class="form-group">
                                <label for="status_keluarga">Status Dalam Keluarga</label>
                                <input type="text" value="{{ $santri->status_keluarga }}" id="status_keluarga" name="status_keluarga" class="form-control @error('status_keluarga') is-invalid @enderror">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-15">
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" value="{{ $santri->nama_ayah }}" id="nama_ayah" name="nama_ayah" class="form-control @error('nama_ayah') is-invalid @enderror">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label text-right" for="nama_ibu">Ibu</label>
                                    <div class="col-lg-6">
                                        <input type="text" value="{{ $santri->nama_ibu }}" id="nama_ibu" name="nama_ibu" class="form-control @error('nama_ibu') is-invalid @enderror">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mb-15">
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" value="{{ $santri->pekerjaan_ayah }}" id="pekerjaan_ayah" name="pekerjaan_ayah" class="form-control @error('pekerjaan_ayah') is-invalid @enderror">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label text-right" for="pekerjaan_ibu">Ibu</label>
                                    <div class="col-lg-6">
                                        <input type="text" value="{{ $santri->pekerjaan_ibu }}" id="pekerjaan_ibu" name="pekerjaan_ibu" class="form-control @error('pekerjaan_ibu') is-invalid @enderror">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mb-15">
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        <textarea class="form-control @error('alamat_ayah') is-invalid @enderror" name="alamat_ayah" id="alamat_ayah" cols="30" rows="5">{{ $santri->alamat_ayah }}</textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label text-right" for="alamat_ibu">Ibu</label>
                                    <div class="col-lg-6">
                                        <textarea class="form-control @error('alamat_ibu') is-invalid @enderror" name="alamat_ibu" id="alamat_ibu" cols="30" rows="5">{{ $santri->alamat_ibu }}</textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mb-15">
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" value="{{ $santri->nama_wali }}" id="nama_wali" name="nama_wali" class="form-control @error('nama_wali') is-invalid @enderror">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label text-right" for="alamat_wali">Alamat</label>
                                    <div class="col-lg-6">
                                        <textarea class="form-control @error('alamat_wali') is-invalid @enderror" name="alamat_wali" id="alamat_wali" cols="30" rows="5">{{ $santri->alamat_wali }}</textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label text-right" for="pekerjaan_wali">Pekerjaan</label>
                                    <div class="col-lg-6">
                                        <input type="text" value="{{ $santri->pekerjaan_wali }}" id="pekerjaan_wali" name="pekerjaan_wali" class="form-control @error('pekerjaan_wali') is-invalid @enderror">
                                    </div>
                                </div>
                            </div>
                        </div>
