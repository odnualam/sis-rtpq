...
htmlCode += '    <img style="height: 26px; margin-left: 10px; margin-right: 25px; margin-bottom: 2px" src="https://upload.wikimedia.org/wikipedia/commons/7/70/Cookie.png" alt=""/>';
htmlCode += '    <div style="color: #FFFFFF; font-size: 14px;">';
htmlCode += '        <b style="padding-right: 5px;">Kami Menggunakan Cookies.</b>';
htmlCode += '        <span style="opacity: 0.75">Situs web ini menggunakan cookie untuk memastikan Anda mendapatkan pengalaman terbaik di situs web kami.</span>';
htmlCode += '    </div>';
htmlCode += '</div>';
